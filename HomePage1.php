...
<head>
    ...
    <title>eShopping | Ecommerce Website Design</title>
...
<div class="header">
    <div class="container">
        <div class="navbar">
            ...
            <nav>
                <ul id="MenuItems">
                    ...
                    <li><a href="../Homepage/Shop%20Page.html">Products</a></li>
        ...
        <div class="row">
            <div class="col-2">
                <h1>Passion For <br>Fashion!</br></h1>
                <p>More than 100,000 people use our website to buy clothes
                    online.<br>Get your clothes for all occasions ranging from sports to official.
                </p>
                <a href="../Homepage/Shop%20Page.html" class="btn">Explore Now &#8594;</a>
            </div>
        </div>
    </div>
</div>
...
<div class="categories">
    <div class="small-container">
        <div class="row">
            <div class="col-3">
                <img src="eShopping/pexels-luis-quintero-11220607.jpg">
            </div>
            <div class="col-3">
                <img src="eShopping/pexels-kevin-malik-9032490.jpg">
            </div>
            <div class="col-3">
                <img src="eShopping/pexels-ira-dulger-1452128.jpg">
            </div>
        </div>
    </div>
...
<div class="small-container">
    ...
    <div class="row">
        <div class="col-4">
            <img src="eShopping/pexels-luis-quintero-11220600.jpg">
            <h4>Adidas Yeezy <br>Foam Runner</br></h4>
            <p>Ksh500.00</p>
        </div>

        <div class="col-4">
            <img src="eShopping/pexels-brenner-oliveira-10495156.jpg">
            <h4>Lacoste Men's Classic<br> Fit L.12.12 Polo</br></h4>
            <p>Ksh800.00</p>
        </div>

        <div class="col-4">
            <img src="eShopping/pexels-styves-exantus-8514111.jpg">
            <h4>Nike Dri-FIT <br>Standard Issue</br></h4>
            <p>Ksh700.00</p>
        </div>

        <div class="col-4">
            <img src="eShopping/pexels-teddy-joseph-2955375.jpg">
            <h4>Black Official <br>Full Suit</br></h4>
            <p>Ksh20000.00</p>
        </div>
    </div>
...
<div class="offer">
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-2">
                <p>Exclusively Available on eShopping</p>
                <h1>Get Sporty Today!</h1>
                <small>
                    Visit our store today to get yourself Great Discounts
                    on all nike products ranging from shoes to sweatpants,
                    that will make you feel comfortable even as you play.</br>
                </small>
                <a href="../Homepage/Shop%20Page.html" class="btn">Buy Now &#8594;</a>
            </div>
        </div>
    </div>
</div>
...
<div class="testimonies">
    ...
    <div class="small-container">
        <div class="row">
            <div class="col-3">
                Free Shipping <br>Country-wide</br>
            </div>

            <div class="col-3">
                Money back <br>Guarantee</br>
            </div>
    ...
    <div class="small-container">
        <div class="row">
            <div class="col-6">
                ...
                <input type="email" id="email" name="" placeholder="Enter your Email Address"></p>
