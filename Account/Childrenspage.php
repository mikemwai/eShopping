...
<head>
    ...
    <title>eShopping | Childrenspage</title>
        ...
        <div class="navbar">
            ...
            <nav>
               ...
               <form action="results.php" class="" method="get">
                    <input type="search" name="user_query" placeholder="search here...">
...
<?php
   ...
   $select = mysqli_query($conn, "SELECT * FROM tbl_product WHERE category_name='Children'");
   
?>

<!-----------Products--------->
<div class="small-container">
    <h2 class="title">Children's Products</h2>
